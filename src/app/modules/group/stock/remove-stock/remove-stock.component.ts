...
@Component({
    ...
    styleUrls: ['./remove-stock.component.scss', '../stock.page.scss'],
})
export class RemoveStockComponent implements OnInit, OnDestroy {
    stockForm: FormGroup;
    isSubmitted: boolean;
    @Input() group$: Observable<Group>;
    group: Group;
    private readonly logger = LoggerService.getLogger(RemoveStockComponent.name);
